                        ...
                        <div className="row">
                            <div>
                                ...
                                <select name="client" required>
                                    <option value="1">Davi (919.929.810-43)</option>
                                    <option value="2">Rodrigo (053.171.190-06)</option>
                                    <option value="3">Robson (708.775.820-92)</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="pet" required>
                                    <option value="1">Junior (Cachorro)</option>
                                    <option value="2">Felix (Gato)</option>
                                    <option value="3">Jair (Pássaro)</option>
                                    <option value="4">Tortuguita (Tartaruga)</option>
                                </select>
                            </div>
                        </div>
                        <div className="row">
