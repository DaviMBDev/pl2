                    ...
                    <body>
                        ...
                        <div className="table">
                            <table>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Davi (919.929.810-43) - Não possui</td>
                                    <td>
                                        <ul>
                                            <li>33.070.553-2</li>
                                        </ul>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>Rodrigo (053.171.190-06) - Não possui</td>
                                    <td>
                                        <ul>
                                            <li>44.587.389-9</li>
                                            <li>26.635.848-2</li>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>Robson (708.775.820-92) - Não possui</td>
                                    <td>
                                        <ul>
                                            <li>37.476.967-9</li>
                                            <li>30.265.942-0</li>
